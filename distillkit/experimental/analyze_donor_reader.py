...
from distillkit.experimental.donor_reader import DonorReaderTransplant, load_reference_tensors
...
def capture_rows_command(args) -> None:
    ...
    from distillkit.experimental.ngram_table import GGUFNGramTable, IQ4NLDequant
