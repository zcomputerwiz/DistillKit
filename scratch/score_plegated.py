...
ARMS = (BASELINE, CONTROL,
        ...
        "borrowed-L24-stage1-1m",
        "hc-L24-learnblend-stage1-1m",
        "hc-L24-learnblend-shuffled-stage1-1m",
        "win-A1-window-stage1-1m",
        "win-A2-shuffled-stage1-1m",
        "win-A3-nosidecar-stage1-1m") + tuple(sorted(
